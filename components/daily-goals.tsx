...
export function DailyGoals() {
  ...
  // Update the calculation of todayActions to handle empty actions array
  ...
  const EmptyState = () => (
    <div className="text-center py-8">
      ...
      <p className="text-muted-foreground mb-2">No daily goals yet.</p>
      <p className="text-sm text-muted-foreground">Start logging eco-actions to track your daily goals!</p>
    </div>
  )
