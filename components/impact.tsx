                  ...
                  <Card>
                    <CardContent className="p-6">
                      <div className="flex flex-col items-center justify-center h-full text-center">
                        ...
                        <h3 className="text-xl font-bold mb-1">You're in the top 15%</h3>
                        <p className="text-sm text-muted-foreground">of eco-warriors making a difference</p>
                      </div>
                    </CardContent>
                  </Card>
                </div>
              ...
              >
                ...
                <div className="mt-4 text-center">
                  ...
                  <p className="text-sm text-muted-foreground max-w-md mx-auto">
                    Your eco-friendly actions contribute to global sustainability efforts. Together with other users,
                    you've helped reduce {formatImpactStat(impactStats.carbonSaved * 10, "kg")} of CO₂ emissions
                    worldwide.
                  </p>
                </div>
              </motion.div>
